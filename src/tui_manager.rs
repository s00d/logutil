...
use ratatui::widgets::{Block, Borders, Gauge, List, ListItem, Paragraph, Row, Scrollbar, ScrollbarOrientation, ScrollbarState, Sparkline, Table, Tabs};
...
impl TuiManager {
    ...
    pub fn draw_list<'a>(&self, items: Vec<ListItem<'a>>) -> List<'a> {
        List::new(items)
